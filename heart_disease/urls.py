...
urlpatterns = [
    ...
    # Model Integration
    path('model-integration/', views.model_integration_view, name='model_integration'),
    path('model-integration/upload/', views.upload_model_view, name='upload_model'),
    path('model-integration/delete/<int:id>/', views.delete_model_metrics, name='delete_model_metrics'),
