...
FEATURE_INFO = {
    ...
    'restecg':  {'label': 'Hasil ECG Istirahat',            'min': 0,   'max': 2,   'step': 1,
                 'choices': [(0,'Normal'),(1,'ST-T Abnormal'),(2,'Hipertrofi Ventrikel Kiri')]},
    'thalach':  {'label': 'Detak Jantung Maksimum',         'min': 60,  'max': 220, 'step': 1},
    'exang':    {'label': 'Angina Akibat Olahraga',         'min': 0,   'max': 1,   'step': 1,
                 'choices': [(0,'Tidak'), (1,'Ya')]},
    'oldpeak':  {'label': 'ST Depression',                  'min': 0.0, 'max': 6.2, 'step': 0.1},
    'slope':    {'label': 'Slope ST Segment',               'min': 0,   'max': 2,   'step': 1,
                 'choices': [(0,'Upsloping'),(1,'Flat'),(2,'Downsloping')]},
    'ca':       {'label': 'Jumlah Pembuluh Mayor',          'min': 0,   'max': 4,   'step': 1},
    'thal':     {'label': 'Thalassemia',                    'min': 0,   'max': 3,   'step': 1,
                 'choices': [(0,'Normal'),(1,'Fixed Defect'),(2,'Reversable Defect'),(3,'Unknown')]},
}
